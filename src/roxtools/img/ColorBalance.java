...
public class ColorBalance {
	...
	static public void balanceColors(float[] pixelsChannel) {
		balanceColors(pixelsChannel, 1.5f, 1.5f) ;
	}
	...
	static public void testGray(File file, float s1, float s2) throws IOException {
	...
	static public void testRGB(File file, float s1, float s2) throws IOException {
		...
		balanceColors(c1, s1, s2) ;
		balanceColors(c2, s1, s2) ;
		balanceColors(c3, s1, s2) ;
